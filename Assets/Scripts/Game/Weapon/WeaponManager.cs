...
public class WeaponManager : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        foreach (var item in GameManager.Instance.GameDataController.WeaponDatas)
            AddWeapon(Instantiate(GameManager.Instance.WeaponDatabase.GetWeapon(item).prefab));
    }
