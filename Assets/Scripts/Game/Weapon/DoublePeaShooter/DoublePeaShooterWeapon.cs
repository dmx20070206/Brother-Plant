...
public class DoublePeaShooterWeapon : WeaponBase
{
    [Header("发射设置")]
    [SerializeField] private DoublePeaProjectile peaPrefab;
    ...
    protected override void ExecuteAttack()
    {
        ...
        {
            // 生成豌豆
            DoublePeaProjectile pea = Instantiate(
                peaPrefab,
