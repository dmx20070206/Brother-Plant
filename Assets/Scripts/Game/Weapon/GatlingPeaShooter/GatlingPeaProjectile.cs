...
public class GatlingPeaProjectile : MonoBehaviour
{
    [Header("飞行设置")]
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("Enemy"))
        {
            ...
            if (enemy != null)
            {
                ...
                result.type = EnemyStatusSystem.StatusType.Poison;
            ...
            EnemyStatusSystem.StatusType type = EnemyStatusSystem.StatusType.Poison;
